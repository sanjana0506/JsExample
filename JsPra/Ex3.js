...
if (scoreDolphins1 > scoreKoalas1 && scoreDolphins1 >= 100) {
  console.log("Dolphins win the trophy ");
} else if (scoreKoalas1 > scoreDolphins1 && scoreKoalas >= 100) {
  console.log("Koalas win the trophy");
} else if (
...
const dolphinsAvgScore = (97 + 112 + 101) / 3; //(96 + 108 + 89) / 3;
const koalasAvgScore = (109 + 95 + 123) / 3; //(88 + 91 + 110) / 3;
const minScore = 100;

if (dolphinsAvgScore > koalasAvgScore && minScore) {
